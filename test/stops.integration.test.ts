        ...
        expect(response.body).toEqual([
            {
                ...
                name: 'Airport',
                connections: [
                    {line: '2', type: 'tram', directions: expect.arrayContaining(['Airport', 'Bridge'])}
                ]
            },
            {
                id: 2,
                name: 'Bank',
                connections: [
                    {line: '1', type: 'tram', directions: expect.arrayContaining(['Suburb', 'Train Station'])}
                ]
            },
            {
                id: 7,
            ...
            },
            {
                ...
                name: 'Bus Terminal',
                connections: [
                    {line: '100', type: 'trolleybus', directions: expect.arrayContaining(['Bus Terminal', 'Lake'])}
                ]
            },
            {
                id: 4,
